       ...
       dbc.Row(
            [
                ...
                html.P(
                   ...
                   " Entre 2015 y 2021 se registraron "+ str(f"{int(TOTCORRUPMENORES):,}") +" casos, lo que representa una tasa de "+
...
#---------Grafica mensual
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.P("Baja California", style={"font-size": 30,"color": "black","background-color": "white"}),
                  ...
                  style={'size': 2,}),
                          html.P(
                          "Los 5 municipios con más corrupción de menores fueron: Tijuana (1,118), Mexicali (793), Ensenada (344), Playas de Rosarito (50) y Tecate (46)",
               ...
               dbc.Col(dbc.Button(([html.P("Ciudad de México", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Corrupciondemenores/blob/main/application/static/cdmx.jpeg?raw=true",
                                    style={'size': 2,}),
                       html.P(
                           "Las 10 alcaldías con más corrupción de menores fueron: Iztapalapa (220), Cuauhtémoc (183), Gustavo A. Madero (167)"
                           ", Tlalpan (104), Coyoacán (79), Álvaro Obregón (78), Azcapotzalco (69), Xochimilco (57), Miguel Hidalgo (57)"
                           " e Iztacalco (55).",
                              style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
                       ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
    ...
    html.Br(),
          ...
          dbc.Col(dbc.Button(([html.P("Guanajuato", style={"font-size": 30,"color": "black","background-color": "white"}),
                       ...
                       html.P(
                           "Los 10 municipios con más corrupción de menores fueron: León (260), Irapuato (183), Celaya (138), Guanajuato (76)"
                           ", Dolores Hidalgo Cuna de la Independencia Nacional (43), San Miguel de Allende (36), Salamanca (33)"
                           ", Cortazar (18), Apaseo el Grande (18) y San Felipe (17)."
               ...
               dbc.Col(dbc.Button(([html.P("Nuevo León", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Corrupciondemenores/blob/main/application/static/nl.jpeg?raw=true"),
                        ...
                        html.P(
                          "Los 10 municipios con más corrupción de menores fueron: Monterrey (276), Guadalupe (153), Apodaca (85), Juárez (77)"
                            ", García (72), San Nicolás de los Garza (67), Santa Catarina (48), Cadereyta Jiménez (25), Pesquería (20)"
                            " y Allende (19).",
                           style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
